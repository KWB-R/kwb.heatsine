...
sinusfit_sw <- do_sinus_optimisation(df = data_sw_selected)
sinusfit_gw <- do_sinus_optimisation(df = data_gw_selected)
...
write_to_csv(get_residuals(predictions$data), "csv/sinus-fit_residuals")
